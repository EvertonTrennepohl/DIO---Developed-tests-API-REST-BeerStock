...
public class BeerServiceTest {
	...
	void whenListBeerIsCalledThenReturnAListOfBeers() {
		...
		assertThat(foundListBeersDTO, is(not(Collections.EMPTY_LIST)));
	...
	void whenListBeerIsCalledThenReturnAnEmptyList() {
		...
		// then
		List<BeerDTO> foundListBeersDTO = beerService.listAll();
		assertThat(foundListBeersDTO, is(Collections.EMPTY_LIST));
	}
	...
	void whenExclusionIsCalledWithValidIdThenABeerShouldBeDeleted() throws BeerNotFoundException {
		...
		Beer expecteDeletedBeer = beerMapper.toModel(expectedDeletedBeerDTO);

		// when
		when(beerRepository.findById(expectedDeletedBeerDTO.getId())).thenReturn(Optional.of(expecteDeletedBeer));
	...
	@Test
	void whenDecrementIsLessThanZeroThenThrowException() {
		// given
		BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
		Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
		...
		assertThrows(BeerStockZeroException.class, () -> beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement));
	}
